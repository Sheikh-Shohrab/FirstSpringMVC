...
public class AppInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletCxt) {
	      ...
	      rootContext.register(RootConfig.class);			//RootConfig class work for every bean
	      rootContext.refresh();
	      ...
	      servletRegisterer.register(WebMvcConfig.class);		//WebMvcConfig class work for views related (viz: .jsp file)
